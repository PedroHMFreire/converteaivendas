...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(baseItemClass, inset && "pl-8 px-2", "px-2", className)}
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn(baseItemClass, "pl-8 pr-2", className)}
    checked={checked}
...
const DropdownMenuShortcut: React.FC<React.HTMLAttributes<HTMLSpanElement>> = React.memo(
  ({ className, ...props }) => (
    <span
...
// Exports agrupados (opcional para organização)
export {
  DropdownMenu,
  DropdownMenuTrigger,
  DropdownMenuContent,
